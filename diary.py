...
def creator():
    dirCheck = input(
        rf"would you like to save to Documents? or to Desktop folder? |doc|desk|:"
    )
    if dirCheck == "doc":
        userCheck = input(
            rf"please go to C:\Users and type in your user name accuratly:"
        )
        ...
        userCheck = input(
            r"please go to C:\Users and type in your user name accurately:"
        )
    ...
    print(
        f"please go to:{userDir}, there will be a folder called 'school notes. All your files will be there"
    )
